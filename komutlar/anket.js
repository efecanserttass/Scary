...
exports.run = async (client, message, args, tools) => {
  ...
  if (!message.member.hasPermission('MANAGE_GUILD') && message.author.id !== '406832593758322688') return message.channels.send('Sorry, you don\'t have permission to create poll!').then(msg => msg.delete({timeout: 10000}));
